...
const ar = {
  ...
  referral: {
    title: "دعوة صديقة",
    rowHint: "شاركي كودك واحصلا معًا على مكافأة",
    subtitle: "شاركي كود دعوتك — وعند أول استشارة مدفوعة تحجزها بكودك، تحصلان معًا على مكافأة.",
    yourCode: "كود دعوتك",
    shareLink: "رابط الدعوة",
    copy: "نسخ",
    copied: "تم النسخ",
    share: "مشاركة الدعوة",
    invited: "دعوات أُرسلت",
    rewarded: "مكافآت مكتسبة",
    inactive: "برنامج الدعوات غير مفعّل حاليًا. تابعينا لمعرفة موعد إطلاقه.",
    shareMessage: (code: string) => `انضمّي إلى Med Aura باستخدام كود دعوتي ${code} واحصلي على مكافأة عند أول استشارة.`,
    rewardSummary: (referrer: string, referee: string) => `${referrer} لكِ، و${referee} لصديقتك — عند أول استشارة مدفوعة تحجزها بكودك.`,
  ...
  editProfile: {
    ...
    dateOfBirthHint: "اختر تاريخ ميلادك",
    selectDate: "اختر التاريخ",
    physicalSectionTitle: "معلومات إضافية",
    physicalSectionHint: "اختيارية — تساعد طبيبك على تقييم حالتك بدقة أكبر",
    biologicalSex: "الجنس",
    male: "ذكر",
    female: "أنثى",
    heightCm: "الطول (سم)",
    weightKg: "الوزن (كجم)",
    aboutWizardTitle: "عرّفنا أكثر عن نفسك",
    aboutWizardBody: "معلومات اختيارية تساعد طبيبك على تقييم حالتك بدقة أكبر عند الاستشارة.",
    finishWizard: "إنهاء",
    skipWizard: "تخطي الآن",
  ...
  security: {
    ...
    disableConfirmTitle: "إلغاء تفعيل التحقق بخطوتين؟",
    disableConfirmBody: "لن يُطلب منك رمز تحقق بعد الآن عند تسجيل الدخول. يمكنك إعادة التفعيل في أي وقت.",
    ...
    backupCodes: "رموز الاسترجاع",
    viewBackupCodes: "عرض رموز استرجاع جديدة",
    regenerateBody: "سيتم إلغاء الرموز القديمة فوراً — احفظي الرموز الجديدة في مكان آمن.",
    passwordLabel: "كلمة المرور",
    passwordPlaceholder: "أدخلي كلمة المرور للمتابعة",
    sessionConfirmTitle: "تأكيد من الجلسة الحالية",
    sessionConfirmBody: "حسابك مرتبط بمزوّد تسجيل الدخول ولا يملك كلمة مرور منفصلة. سنستخدم جلستك الحالية للمتابعة.",
    confirm: "تأكيد",
    cancel: "إلغاء",
    ...
    totpSetupDesc: "افتحي تطبيق المصادقة، اختاري إضافة حساب يدوياً، وأدخلي هذا المفتاح:",
    manualKey: "مفتاح الإعداد",
    ...
    // Sign-in verification step (separate screen from the settings above).
    verifyTitle: "التحقق من هويتك",
    verifySubtitleOtp: "أرسلنا رمزاً مكوّناً من 6 أرقام إلى بريدك الإلكتروني.",
    verifySubtitleTotp: "أدخلي الرمز الظاهر في تطبيق المصادقة.",
    verifySubtitleBackup: "أدخلي أحد رموز الاسترجاع التي حفظتِها.",
  ...
  auth: {
    ...
    verifyEmailTitle: "تحققي من بريدك الإلكتروني",
    verifyEmailBody: "أرسلنا رابط تحقق إلى بريدك. افتحي الرسالة واضغطي الرابط، ثم عودي إلى التطبيق لتسجيل الدخول.",
    resendVerification: "إعادة إرسال رابط التحقق",
    verificationSent: "تم إرسال رابط جديد. راجعي صندوق الوارد والرسائل غير المرغوبة.",
  },
  tabs: {
    home: "الرئيسية",
    explore: "استكشاف",
  ...
  practice: {
    ...
    currency: "العملة",
    timezone: "المنطقة الزمنية للمواعيد",
    timezoneHint: "مثال: Asia/Riyadh أو Europe/Istanbul",
  ...
  profile: {
    ...
    security: "الأمان والتحقق بخطوتين",
    securityHint: "احمي حسابك برمز إضافي عند تسجيل الدخول",
    ...
    deleteAccount: "طلب حذف الحساب والبيانات",
    deleteAccountHint: "حذف حسابك وبياناتك الشخصية وفق السياسة",
    faq: "الأسئلة الشائعة",
    about: "عن التطبيق",
    version: "الإصدار",
...
const en: typeof ar = {
  ...
  referral: {
    ...
    rowHint: "Share your code and get a reward together",
    subtitle: "Share your invite code — when your friend books and pays for their first consultation, you both get a reward.",
    ...
    inactive: "The referral program isn't active right now. Check back soon.",
    shareMessage: (code: string) => `Join Med Aura with my invite code ${code} and get a reward on your first consultation.`,
    rewardSummary: (referrer: string, referee: string) => `${referrer} for you, and ${referee} for your friend — on their first paid consultation.`,
    loadError: "Couldn't load your referral info.",
  },
  editProfile: {
    save: "Save changes",
    ...
    dateOfBirthHint: "Select your date of birth",
    selectDate: "Select date",
    physicalSectionTitle: "Additional info",
    physicalSectionHint: "Optional — helps your doctor assess your case more accurately",
    biologicalSex: "Sex",
    male: "Male",
    female: "Female",
    heightCm: "Height (cm)",
    weightKg: "Weight (kg)",
    aboutWizardTitle: "Tell us more about yourself",
    aboutWizardBody: "Optional details that help your doctor assess your case more accurately.",
    finishWizard: "Finish",
    skipWizard: "Skip for now",
  ...
  security: {
    ...
    disableConfirmTitle: "Disable two-factor verification?",
    disableConfirmBody: "You won't be asked for a verification code when signing in anymore. You can re-enable it anytime.",
    email: "Email",
    ...
    regenerateBody: "Old codes will stop working immediately — save the new codes somewhere safe.",
    passwordLabel: "Password",
    passwordPlaceholder: "Enter your password to continue",
    sessionConfirmTitle: "Confirm with your current session",
    sessionConfirmBody: "Your account uses a sign-in provider and has no separate password. Your current session will be used to continue.",
    confirm: "Confirm",
    cancel: "Cancel",
    ...
    totpSetupDesc: "Open your authenticator app, choose add account manually, and enter this key:",
    manualKey: "Setup key",
    ...
    verifySubtitleOtp: "We sent a 6-digit code to your email.",
    verifySubtitleTotp: "Enter the code shown in your authenticator app.",
    verifySubtitleBackup: "Enter one of the backup codes you saved.",
  ...
  auth: {
    ...
    verifyEmailBody: "We sent a verification link to your email. Open it, then return to the app to sign in.",
    resendVerification: "Resend verification link",
    verificationSent: "A new link was sent. Check your inbox and spam folder.",
  },
  tabs: {
    home: "Home",
    explore: "Explore",
  ...
  practice: {
    ...
    timezoneHint: "For example: Asia/Riyadh or Europe/Istanbul",
  ...
  profile: {
    ...
    security: "Security & two-factor verification",
    securityHint: "Protect your account with an extra code at sign-in",
    ...
    deleteAccountHint: "Request deletion of your account and data",
    faq: "FAQ",
    about: "About the app",
    version: "Version",
