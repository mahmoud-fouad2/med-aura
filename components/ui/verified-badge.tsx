...
export function VerifiedBadge({
  ...
  return (
    <span
      className={cn(
        "inline-flex items-center gap-1 rounded-lg bg-primary px-2.5 py-1 text-[11px] font-bold text-primary-foreground ring-1 ring-white/20",
        className
      )}
    >
