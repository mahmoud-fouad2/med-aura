  ...
  return (
    <div className="flex min-h-svh flex-col">
      ...
      <main className="flex-1">
        <PageHero
          eyebrow="معرض النتائج والحالات"
          title="نتائج واقعية وحالات موثّقة بموافقة مسبقة"
          subtitle="استكشفي تحولات حقيقية لأبرز الإجراءات التجميلية مع سلايدر المقارنة التفاعلي، منشورة بموافقة صريحة من المراجعين وتدقيق مهني صارم."
        />
